...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f4f7fa; padding: 40px 0;">
  ...
  `;
    ...
    async sendSignInAlert(dynamicTemplateData, imgArray) {
        const html = `
      <!doctype html>
      <html lang="en">
      <head>
...
<div style="max-width: 550px; width: 100%; margin: 20px auto; text-align: center; padding: 0;">
        ...
        <div style="display: flex; min-width: 100%; justify-content: space-between; align-items: stretch; gap: 15px;">
            ...
            ">
                ...
                <p style="font-size: 13px; color: #666; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.browser}</p>
                <p style="font-size: 13px; color: #666; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.os}</p>
            </div>
            ...
            ">
                ...
                <p style="font-size: 13px; color: #222; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.geoLocation}</p>
                <p style="font-size: 13px; color: #222; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.ip}</p>
            </div>
            ...
            ">
                ...
                <p style="font-size: 13px; color: #666; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.date}</p>
                <p style="font-size: 13px; color: #666; margin: 0; line-height: 1.5;">${dynamicTemplateData === null || dynamicTemplateData === void 0 ? void 0 : dynamicTemplateData.time}</p>
            </div>
        </div>
    </div>
