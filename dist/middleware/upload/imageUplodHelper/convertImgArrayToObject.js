    ...
    return files.reduce((total, file) => {
        ...
        if (total[file.fieldname]) {
            if (Array.isArray(total[file.fieldname])) {
                total[file.fieldname].push(fileUrl);
            }
            else {
                total[file.fieldname] = [total[file.fieldname], fileUrl];
            }
        }
        else {
