...
exports.getAllUsersWithWallets = exports.updateUserRole = exports.getUserWithPagination = exports.createSuperAdminRole = exports.getDeleteUser = exports.getSingleUser = exports.getAllUser = exports.updateUser = exports.getUserBy = exports.authForgetPasswordVarification = exports.authForgetPassword = exports.getUser = exports.createUser = exports.authUserSignOut = exports.authUserSignIn = exports.authUserSignUp = void 0;
...
exports.authUserSignUp = (0, withTransaction_1.default)(async (req, res, next, tx) => {
    try {
        ...
        const resDoc = (0, responseHandler_1.responseHandler)(201, "User Created successfully", {
            id: user.id,
            name: user.name,
            email: user.email,
            phone: user.phone,
...
const authUserSignIn = async (req, res, next) => {
    ...
    try {
        ...
        const resDoc = (0, responseHandler_1.responseHandler)(200, "Login successfully", {
...
const authForgetPassword = async (req, res, next) => {
    ...
    try {
        ...
        res
            .status(200)
            .json({ message: "Forget Password OTP sent email successfully" });
    }
    catch (error) {
        next(error);
    }
...
const authForgetPasswordVarification = async (req, res, next) => {
    try {
        ...
        res
            .status(200)
            .json({ message: "Forget Password verification successful", user });
    }
    catch (error) {
        next(error);
    }
...
exports.updateUser = (0, withTransaction_1.default)(async (req, res, next, tx) => {
    ...
    try {
        ...
        const userId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.user_info_encrypted) === null || _b === void 0 ? void 0 : _b.id;
        const payload = {
            ...(((_c = req.body) === null || _c === void 0 ? void 0 : _c.phone) && { phone: req.body.phone }),
            ...(((_d = req.body) === null || _d === void 0 ? void 0 : _d.name) && { name: req.body.name }),
            ...(((_e = req.body) === null || _e === void 0 ? void 0 : _e.bio) && { bio: req.body.bio }),
            ...(((_f = req.body) === null || _f === void 0 ? void 0 : _f.language) && { language: req.body.language }),
            ...(((_g = req.body) === null || _g === void 0 ? void 0 : _g.languageName) && { languageName: req.body.languageName }),
            ...(((_h = req.body) === null || _h === void 0 ? void 0 : _h.currencyCode) && { currencyCode: req.body.currencyCode }),
            ...(((_j = req.body) === null || _j === void 0 ? void 0 : _j.currencyName) && { currencyName: req.body.currencyName }),
            ...(((_k = req.body) === null || _k === void 0 ? void 0 : _k.currencySymbol) && { currencySymbol: req.body.currencySymbol }),
        };
...
exports.createSuperAdminRole = (0, withTransaction_1.default)(async (req, res, next, tx) => {
    try {
        ...
        res
            .status(201)
            .json({ message: "Super Admin Role created successfully", role });
    }
    catch (error) {
        next(error);
    }
...
exports.getUserWithPagination = getUserWithPagination;
...
const getAllUsersWithWallets = async (req, res, next) => {
    try {
        const users = await authService.getAllUsersWithWallets();
        const resDoc = (0, responseHandler_1.responseHandler)(200, "Users with wallet info retrieved successfully", users);
        return res.status(resDoc.statusCode).json(resDoc);
    }
    catch (error) {
        next(error);
...
exports.getAllUsersWithWallets = getAllUsersWithWallets;
