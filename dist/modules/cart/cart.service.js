...
class CartService extends base_service_1.BaseService {
    constructor(repository) {
        ...
        this.updateCartItem = async (payload, tx) => {
            ...
            const payloadInfo = {
                countryCombinationId: (_h = cartProductAllVariants[0].productShipping[0].rate) === null || _h === void 0 ? void 0 : _h.countryCombinationId,
                weightCategoryId: weightCategory === null || weightCategory === void 0 ? void 0 : weightCategory.id,
