...
class BlogService {
    ...
    async createBlog(payloadFiles, payload, tx) {
        ...
        // both  are required
        if (!title || !details || !industryId || !topicId)
            throw new errors_1.NotFoundError("Title, Details, Industry, and Topic are required.");
