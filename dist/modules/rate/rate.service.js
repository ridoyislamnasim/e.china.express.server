...
const category_1688_repository_1 = __importDefault(require("../category1688/category.1688.repository"));
...
class RateService {
    ...
    async findRateByCriteria(payload) {
    ...
    async bulkAdjustRate(payload, transaction) {
        ...
        // Validate required fields.
        if ((adjustIsPercent === undefined || adjustIsPercent === null) ||
            !adjustMode ||
        ...
        const countryCombinationId = existingCountryCombination === null || existingCountryCombination === void 0 ? void 0 : existingCountryCombination.id;
        // small helper to compute the adjusted price
        const computeNewPrice = (existingPrice) => {
        ...
        const adjustCategory = async (catId) => {
            const queryPayload = { weightCategoryId, shippingMethodId, category1688Id: catId, countryCombinationId };
        ...
        const queryPayload = { weightCategoryId, shippingMethodId, countryCombinationId, category1688Id: 51 };
