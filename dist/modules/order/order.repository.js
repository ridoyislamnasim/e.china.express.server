...
class OrderRepository {
    ...
    async createOrder(payload, tx) {
        const { orderId, shippingCost, coupon, userRef, customerName, customerPhone, customerEmail, customerCity, customerAddress, customerHouse, customerRoad, customerThana, customerAltPhone, paymentMethod, note, } = payload;
        ...
        const products = carts.map((cart) => {
            ...
            const price = (inventoryRef === null || inventoryRef === void 0 ? void 0 : inventoryRef.price) || 0;
            const discountAmount = (inventoryRef === null || inventoryRef === void 0 ? void 0 : inventoryRef.discountAmount) || 0;
            let couponDiscount = 0;
            if (appliedCoupon) {
                if (String(appliedCoupon.categoryRef) === String(productRef.categoryRef) ||
            ...
            return {
                ...
                quantity,
                price,
                mrpPrice: inventoryRef === null || inventoryRef === void 0 ? void 0 : inventoryRef.mrpPrice,
            };
        });
