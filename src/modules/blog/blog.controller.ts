...
export class BlogController {
  ...
  getSingleBlogWithSlug = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const slug = req.params.slug as string;
  ...
  getAllBlogsByPagination = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  getAllTrendingContent = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  getAllFeaturedContent = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const blog = await BlogService.getAllFeaturedContent();
      const resDoc = responseHandler(
        200,
        "Featured Content fetched successfully",
        blog,
      );
      res.status(resDoc.statusCode).json(resDoc);
    },
  ...
  getBlogsByTags = withTransaction(
    async (req: Request, res: Response, next: NextFunction, tx: any) => {
      ...
      if (!tags || !Array.isArray(tags) || tags.length === 0) {
        return res
          .status(400)
          .json(responseHandler(400, "Tags array is required"));
      }
  ...
  getAllTagsByPagination = withTransaction(
    async (req: Request, res: Response, next: NextFunction, tx: any) => {
      let payload = {
        page: req.query.page,
        limit: req.query.limit,
  ...
  getAllTopicByPagination = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const payload = {
      ...
      console.log(
        "🚀 ~ blog.controller.ts:272 ~ BlogController ~ payload:",
        payload,
      );
  ...
  createIndustries = withTransaction(
    async (req: Request, res: Response, next: NextFunction, tx: any) => {
      ...
      const resDoc = responseHandler(
        201,
        "Industries created successfully",
        result,
      );
      res.status(resDoc.statusCode).json(resDoc);
    },
  ...
  getAllIndustriess = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const result = await BlogService.getAllIndustriess();

      const resDoc = responseHandler(
        200,
        "Industriess fetched successfully",
        result,
      );
      res.status(resDoc.statusCode).json(resDoc);
    },
  ...
  getSingleIndustries = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const topicId = Number(req.params.id);
  ...
  deleteIndustries = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const resDoc = responseHandler(
        200,
        "Industries deleted successfully",
        result,
      );
      res.status(resDoc.statusCode).json(resDoc);
    },
  ...
  getAllIndustriesByPagination = catchError(
    async (req: Request, res: Response, next: NextFunction) => {
      const payload = {
        page: req.query.page || 1,
        limit: req.query.limit || 10,
