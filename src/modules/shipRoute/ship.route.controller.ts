...
class ShipRouteController {
  createShipRoute = withTransaction(
    async (req: Request, res: Response, next: NextFunction, tx: any) => {
      try {
        ...
        const resDoc = responseHandler(
          201,
          "ShipRoute Created successfully",
          shipRoute,
        );
  ...
  getAllShipRoutes = async (
    ...
    try {
      ...
      const resDoc = responseHandler(
        200,
        "ShipRoutes retrieved successfully",
        shipRoutes,
      );
      res.status(resDoc.statusCode).json(resDoc);
    } catch (error) {
  ...
  updateShipRoute = withTransaction(
    async (req: Request, res: Response, next: NextFunction, tx: any) => {
      try {
        ...
        const updatedShipRoute = await shipRouteService.updateShipRoute(
          id,
          payload,
          tx,
        );
        const resDoc = responseHandler(
          200,
          `ShipRoute with id ${id} updated successfully`,
          updatedShipRoute,
        );
        res.status(resDoc.statusCode).json(resDoc);
      } catch (error) {
  ...
  deleteShipRoute = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const resDoc = responseHandler(
        200,
        `ShipRoute with id ${id} deleted successfully`,
        null,
      );
      res.status(resDoc.statusCode).json(resDoc);
    } catch (error) {
