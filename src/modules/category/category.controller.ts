...
export class CategoryController {
  createCategory = withTransaction(async (req: Request, res: Response, next: NextFunction, tx: any) => {
    const payloadFiles = {
      files: req.files,
    };
    const payload = {
  ...
  getCategoryWithPagination = catchError(async (req: Request, res: Response, next: NextFunction) => {
    let payload = {
      page: req.query.page,
  ...
  getSingleCategory = catchError(async (req: Request, res: Response, next: NextFunction) => {
  ...
  getSingleCategoryWithSlug = catchError(async (req: Request, res: Response, next: NextFunction) => {
    const slug = req.params.slug;
  ...
  updateCategory = catchError(async (req: Request, res: Response, next: NextFunction) => {
    const slug = req.params.slug;
    const payloadFiles = {
      files: req.files,
    };
  ...
  updateCategoryStatus = catchError(async (req: Request, res: Response, next: NextFunction) => {
    const slug = req.params.slug;
