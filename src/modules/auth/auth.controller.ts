...
export const authUserSignIn = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  ...
  try {
    ...
    console.log(
      "Setting access token cookie with options access:",
      accessCookieOptions,
    );
    ...
    console.log(
      "Setting refresh token cookie with options refresh:",
    ...
    const resDoc = responseHandler(200, "Login successfully", {
...
export const authForgetPasswordVarification = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
...
export const getUserBy = withTransaction(
  async (req: Request, res: Response, next: NextFunction, tx: any) => {
...
export const createSuperAdminRole = withTransaction(
  async (req: Request, res: Response, next: NextFunction, tx: any) => {
    try {
...
export const getAllUsersWithWallets = async (
  req: Request,
  res: Response,
  next: NextFunction,
) => {
  try {
    ...
    const resDoc = responseHandler(
      200,
      "Users with wallet info retrieved successfully",
      users,
    );
