...
class BandingController {
  ...
  getBandingsWithPagination = catchError(
    async (req: Request, res: Response) => {
      ...
      const resDoc = responseHandler(
        200,
        "Bandings retrieved successfully",
        bandings,
      );
      res.status(resDoc.statusCode).json(resDoc);
    },
  ...
  getBandingsByType = catchError(async (req: Request, res: Response) => {
    ...
    const resDoc = responseHandler(
      200,
      `Bandings of type ${type} retrieved`,
      bandings,
    );
    res.status(resDoc.statusCode).json(resDoc);
  });
  ...
  getBandingsByCategory = catchError(async (req: Request, res: Response) => {
    ...
    const resDoc = responseHandler(
      200,
      `Bandings of category ${category} retrieved`,
      bandings,
    );
    res.status(resDoc.statusCode).json(resDoc);
  });
  ...
  getBandingsByStatus = catchError(async (req: Request, res: Response) => {
    ...
    const resDoc = responseHandler(
      200,
      `Bandings with status ${status} retrieved`,
      bandings,
    );
    res.status(resDoc.statusCode).json(resDoc);
  });
  ...
  updateBandingStatus = catchError(async (req: Request, res: Response) => {
    ...
    const banding = await bandingService.updateBandingStatus(
      id,
      status,
      updatedBy,
    );
