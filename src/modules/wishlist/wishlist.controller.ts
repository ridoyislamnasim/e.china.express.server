...
class WishListController {
  createWishList = withTransaction(async (req: Request, res: Response, next: NextFunction, tx: any) => {
    const payload = {
  ...
  getWishListWithPagination = catchError(async (req: Request, res: Response) => {
